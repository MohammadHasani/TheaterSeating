"""
Django settings for theater_seating project.
...
SECRET_KEY = 'django-insecure-sr--$zja9ah1%_ra3x20vdin9h@oi=@-9+4u+#f20gfk8)gz$f'
...
WSGI_APPLICATION = 'theater_seating.wsgi.application'
